      ...
      <div className="andes-contenido">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 md:gap-10">
          <div className="space-y-4 border-b border-b-[#DBD9D9] md:border-none pb-3 md:pm-0">
            ...
            <div className={`${openSection === 'contact' ? 'block' : 'hidden'} md:block space-y-2`}>
              ...
              <button
                ...
                className="relative mt-3 px-5 py-2 border border-black text-black overflow-hidden transition-colors duration-300 before:absolute before:top-0 before:left-0 before:h-full before:w-0 before:bg-black before:transition-all before:duration-300 hover:before:w-full hover:text-white"
              >
          ...
          <div className="space-y-4 border-b border-b-[#DBD9D9] md:border-none pb-3 md:pm-0">
            ...
            <ul className={`${openSection === 'help' ? 'block' : 'hidden'} md:block space-y-2`}>
              <li onClick={() => goTo('contact-us')} className="flex cursor-pointer hover:underline">
                {lang === 'es' ? 'Contáctenos' : 'Contact us'}
                <img src="/images/footer/directionBlack.svg" className="h-5 w-5 ml-3" />
              </li>
              <li onClick={() => goTo('blogs')} className="flex cursor-pointer hover:underline">
                {lang === 'es' ? 'Blog de viaje' : 'Travel blog'}
                <img src="/images/footer/directionBlack.svg" className="h-5 w-5 ml-3" />
              </li>
              <li onClick={() => goTo('travel-planner')} className="flex cursor-pointer hover:underline">
          ...
          <div className="space-y-4 border-b border-b-[#DBD9D9] md:border-none pb-3 md:pm-0">
            ...
            <ul className={`${openSection === 'company' ? 'block' : 'hidden'} md:block space-y-2`}>
              <li onClick={() => goTo('about-us')} className="flex cursor-pointer hover:underline">
                {lang === 'es' ? 'Sobre Andes' : 'About Andes'}
                <img src="/images/footer/directionBlack.svg" className="h-5 w-5 ml-3" />
              </li>
              <li onClick={() => goTo('about-us#values')} className="flex cursor-pointer hover:underline">
                {lang === 'es' ? 'Nuestros valores' : 'Our values'}
                <img src="/images/footer/directionBlack.svg" className="h-5 w-5 ml-3" />
              </li>
              <li onClick={() => goTo('about-us#sustainable')} className="flex cursor-pointer hover:underline">
                {lang === 'es' ? 'Proyectos sociales' : 'Social projects'}
                <img src="/images/footer/directionBlack.svg" className="h-5 w-5 ml-3" />
              </li>
              <li onClick={() => goTo('esnna')} className="flex cursor-pointer hover:underline">
          ...
          <div className="space-y-4 border-b border-b-[#DBD9D9] md:border-none pb-3 md:pm-0">
            ...
            <ul className={`${openSection === 'legal' ? 'block' : 'hidden'} md:block space-y-2`}>
              <li onClick={() => goTo('terms-conditions')} className="flex cursor-pointer hover:underline">
                {lang === 'es' ? 'Términos y condiciones' : 'Terms & Conditions'}
                <img src="/images/footer/directionBlack.svg" className="h-5 w-5 ml-3" />
              </li>
              <li onClick={() => goTo('privacy-policy')} className="flex cursor-pointer hover:underline">
        ...
        <div className="mt-12 border-t border-[#BFBFBF] pt-6 text-center opacity-70">
